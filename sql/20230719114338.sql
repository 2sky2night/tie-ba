...
Backup Time: 2023-07-19 22:09:00
*/
...
CREATE TABLE `article` (
  ...
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '帖子的标题',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '帖子的内容',
  `createTime` datetime DEFAULT NULL COMMENT '发帖的时间',
  `bid` int DEFAULT NULL COMMENT '吧的id',
  `uid` int DEFAULT NULL COMMENT '用户的id',
  `photo` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '帖子的配图',
  PRIMARY KEY (`aid`),
...
CREATE TABLE `bar` (
  ...
  `uid` int DEFAULT NULL COMMENT '用户的id',
  `bdesc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '吧的描述',
  `photo` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '吧的头像',
  PRIMARY KEY (`bid`),
  KEY `uid_bar` (`uid`),
...
CREATE TABLE `comment` (
  ...
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '评论的内容',
...
CREATE TABLE `user` (
  ...
  `avatar` varchar(999) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'http://127.0.0.1:3000/img/default_avatar.png' COMMENT '头像地址',
  `state` tinyint DEFAULT '1' COMMENT '用户的状态 0注销 1正常用户',
  `udesc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '这个人很懒，简介都不写呢~' COMMENT '用户简介',
  PRIMARY KEY (`uid`)
